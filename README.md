...
|----------------------------------|----------------|---------------------|----------------|----------------|-----------------|------------------|-------------------|--------------|-----------------------------|---------------|-----------------|----------------------------|-------------|----------------------------|--------|------------------|-----------------------------|--------------|-----------------------------|
| metrics/detector.json            | -              | -                   | -              | -              | -               | -                | -                 | -            | 0.178                       | 0.311         | 3.329           | 3.361                      | 6.69        | 0.0                        | 99     | 0.443            | 0.13                        | 0.573        | 0.0                         |
| metrics/detector/coco_train.json | 0.89           | 0.79                | 0.89           | -1.0           | 0.857           | 0.915            | 0.915             | 218          | -                           | -             | -               | -                          | -           | -                          | -      | -                | -                           | -            | -                           |
| metrics/detector/coco_val.json   | 0.675          | 0.442               | 0.537          | -1.0           | 0.552           | 0.638            | 0.638             | 36           | -                           | -             | -               | -                          | -           | -                          | -      | -                | -                           | -            | -                           |
...
|----------------------------------|----------------|---------------------|----------------|----------------|---------------------|----------------|--------------|------------------|-------------|--------|-------------------|--------------|
| metrics/keypoint.json            | -              | -                   | -              | -              | -                   | -              | -            | 0.444            | 0.55        | 59     | 0.876             | 0.121        |
| metrics/keypoint/coco_train.json | 0.774          | 0.634               | 0.604          | 0.923          | 0.821               | 0.797          | 218          | -                | -           | -      | -                 | -            |
| metrics/keypoint/coco_val.json   | 0.469          | 0.326               | 0.332          | 0.69           | 0.566               | 0.552          | 36           | -                | -           | -      | -                 | -            |

| Path                      | eval.iou_score   | eval.loss   | step   | train.iou_score   | train.loss   |
|---------------------------|------------------|-------------|--------|-------------------|--------------|
| metrics/segmentation.json | 0.578            | 0.264       | 59     | 0.678             | 0.183        |
