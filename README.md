...
|--------------------------------|-------------------|--------------------|--------------------|-----------------|------------------|------------------|
| metrics/end_2_end_summary.json | 0.117             | 0.153              | 0.286              | 0.013           | 0.026            | 0.052            |
...
|----------------------------------|----------------|---------------------|----------------|----------------|-----------------|------------------|-------------------|--------------|-------------------------------|---------------|-----------------|----------------------------|-------------|----------------------------|--------|------------------|-----------------------------|--------------|-----------------------------|
| metrics/detector.json            | -              | -                   | -              | -              | -               | -                | -                 | -            | 0.143                         | 0.288         | 3.225           | 2.331                      | 5.556       | 0.0                        | 119    | 1.252            | 0.473                       | 1.725        | 0.0                         |
| metrics/detector/coco_train.json | 0.851          | 0.676               | 0.829          | -1.0           | 0.785           | 0.835            | 0.835             | 218          | -                             | -             | -               | -                          | -           | -                          | -      | -                | -                           | -            | -                           |
| metrics/detector/coco_val.json   | 0.72           | 0.429               | 0.499          | -1.0           | 0.493           | 0.6              | 0.6               | 35           | -                             | -             | -               | -                          | -           | -                          | -      | -                | -                           | -            | -                           |
...
| metrics/keypoint/coco_train.json | 0.741          | 0.564               | 0.505          | 0.923          | 0.79                | 0.742          | 218          | -                | -           | -      | -                 | -            |
| metrics/keypoint/coco_val.json   | 0.6            | 0.374               | 0.365          | 0.75           | 0.543               | 0.536          | 35           | -                | -           | -      | -                 | -            |
