...
add-images:
	python scripts/add-images-to-label-studio-project.py --source-dir ./new-images/ --label-studio-project ${PROJECT_ID} --label-studio-host ${LABEL_STUDIO_URL} --label-studio-api-token ${LABEL_STUDIO_ACCESS_TOKEN}  --n-images 1 --shuffle-images
